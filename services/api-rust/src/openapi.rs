...
#[openapi(
    paths(
        ...
        crate::me::controller::register_device,
        crate::me::controller::unregister_device,
        crate::discover::controller::discover,
        crate::discover::controller::density,
        crate::swipes::controller::create_swipe,
        crate::matches::controller::list,
        crate::matches::controller::unmatch,
        crate::notifications::controller::counts,
        crate::proposals::controller::create,
        crate::proposals::controller::list_for_match,
        crate::proposals::controller::respond,
        crate::proposals::controller::list_upcoming,
        crate::proposals::controller::list_history,
        crate::proposals::controller::list_awaiting_feedback,
        crate::proposals::controller::save_feedback,
    ...
    components(schemas(
        ...
        crate::me::dto::UpdateSkillLevelsDto,
        crate::me::dto::SkillLevelInput,
        crate::me::dto::DeletePhotoDto,
        crate::me::dto::RegisterDeviceDto,
        crate::me::dto::UnregisterDeviceDto,
        crate::me::controller::PhotoUploadForm,
        crate::me::service::MeResponse,
        crate::discover::service::DiscoverProfile,
        crate::discover::controller::DensityResponse,
        crate::discover::service::SkillLevelEntry,
        ...
        crate::proposals::dto::RespondProposalDto,
        crate::proposals::dto::ProposalAction,
        crate::proposals::service::ProposalResponse,
        crate::proposals::service::UpcomingSession,
        crate::proposals::service::PlayedSession,
        crate::proposals::dto::SessionFeedbackDto,
        crate::models::SessionFeedback,
        crate::models::SessionOutcome,
