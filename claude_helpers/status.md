...
> repaso completo del 2026-08-06 con los bloqueos duros (applicationId
> `com.example`, firma de debug, nombre e icono de fábrica, política de
> privacidad), lo que rompería la experiencia con usuarios reales (push,
> reportes sin revisar, rate limiting) y qué hace falta de tu parte.
> Esta sección de abajo sigue siendo el backlog general.
